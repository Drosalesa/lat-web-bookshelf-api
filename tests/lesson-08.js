...
async function run() {
  ...
  await test('GET /books — el servidor está corriendo y el modelo Book funciona', async () => {
  ...
  await test('POST /books — la respuesta incluye un campo reviews', async () => {
    const res = await fetch(`${BASE}/books`, {
      method: 'POST',
  ...
  await test('GET /books/:id — el documento book incluye el arreglo reviews', async () => {
