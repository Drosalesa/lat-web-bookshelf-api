...
async function run() {
  ...
  await test('POST /books — crea un libro', async () => {
  ...
  await test('POST /reviews — crea una reseña vinculada al libro', async () => {
  ...
  await test('GET /reviews — devuelve las reseñas con el campo book resuelto (populate)', async () => {
